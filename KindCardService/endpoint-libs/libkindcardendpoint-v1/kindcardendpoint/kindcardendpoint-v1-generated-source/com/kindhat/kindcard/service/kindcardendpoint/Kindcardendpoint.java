...
public class Kindcardendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "insertKindCard".
   *
   * This request holds the parameters needed by the kindcardendpoint server.  After setting any
   * optional parameters, call the {@link InsertKindCard#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.kindhat.kindcard.service.kindcardendpoint.model.KindCard}
   * @return the request
   */
  public InsertKindCard insertKindCard(com.kindhat.kindcard.service.kindcardendpoint.model.KindCard content) throws java.io.IOException {
    InsertKindCard result = new InsertKindCard(content);
    initialize(result);
    return result;
  }

  public class InsertKindCard extends KindcardendpointRequest<com.kindhat.kindcard.service.kindcardendpoint.model.KindCard> {
     ...
     * This request holds the parameters needed by the the kindcardendpoint server.  After setting any
     * optional parameters, call the {@link InsertKindCard#execute()} method to invoke the remote
     * operation. <p> {@link InsertKindCard#initialize(com.google.api.client.googleapis.services.Abstr
     ...
     * @since 1.13
     */
    protected InsertKindCard(com.kindhat.kindcard.service.kindcardendpoint.model.KindCard content) {
      super(Kindcardendpoint.this, "POST", REST_PATH, content, com.kindhat.kindcard.service.kindcardendpoint.model.KindCard.class);
    }

    @Override
    public InsertKindCard setAlt(java.lang.String alt) {
      return (InsertKindCard) super.setAlt(alt);
    }

    @Override
    public InsertKindCard setFields(java.lang.String fields) {
      return (InsertKindCard) super.setFields(fields);
    }

    @Override
    public InsertKindCard setKey(java.lang.String key) {
      return (InsertKindCard) super.setKey(key);
    }

    @Override
    public InsertKindCard setOauthToken(java.lang.String oauthToken) {
      return (InsertKindCard) super.setOauthToken(oauthToken);
    }

    @Override
    public InsertKindCard setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (InsertKindCard) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public InsertKindCard setQuotaUser(java.lang.String quotaUser) {
      return (InsertKindCard) super.setQuotaUser(quotaUser);
    }

    @Override
    public InsertKindCard setUserIp(java.lang.String userIp) {
      return (InsertKindCard) super.setUserIp(userIp);
    }

    @Override
    public InsertKindCard set(String parameterName, Object value) {
      return (InsertKindCard) super.set(parameterName, value);
    }
  }
  ...
  /**
   * Create a request for the method "removeKindCard".
   *
   * This request holds the parameters needed by the kindcardendpoint server.  After setting any
   * optional parameters, call the {@link RemoveKindCard#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @return the request
   */
  public RemoveKindCard removeKindCard(java.lang.Long id) throws java.io.IOException {
    RemoveKindCard result = new RemoveKindCard(id);
    initialize(result);
    return result;
  }

  public class RemoveKindCard extends KindcardendpointRequest<Void> {
     ...
     * This request holds the parameters needed by the the kindcardendpoint server.  After setting any
     * optional parameters, call the {@link RemoveKindCard#execute()} method to invoke the remote
     * operation. <p> {@link RemoveKindCard#initialize(com.google.api.client.googleapis.services.Abstr
     * actGoogleClientRequest)} must be called to initialize this instance immediately after invoking
     * the constructor. </p>
     *
     * @param id
     * @since 1.13
     */
    protected RemoveKindCard(java.lang.Long id) {
      super(Kindcardendpoint.this, "DELETE", REST_PATH, null, Void.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }

    @Override
    public RemoveKindCard setAlt(java.lang.String alt) {
      return (RemoveKindCard) super.setAlt(alt);
    }

    @Override
    public RemoveKindCard setFields(java.lang.String fields) {
      return (RemoveKindCard) super.setFields(fields);
    }

    @Override
    public RemoveKindCard setKey(java.lang.String key) {
      return (RemoveKindCard) super.setKey(key);
    }

    @Override
    public RemoveKindCard setOauthToken(java.lang.String oauthToken) {
      return (RemoveKindCard) super.setOauthToken(oauthToken);
    }

    @Override
    public RemoveKindCard setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (RemoveKindCard) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public RemoveKindCard setQuotaUser(java.lang.String quotaUser) {
      return (RemoveKindCard) super.setQuotaUser(quotaUser);
    }

    @Override
    public RemoveKindCard setUserIp(java.lang.String userIp) {
      return (RemoveKindCard) super.setUserIp(userIp);
    }
    ...
    public RemoveKindCard setId(java.lang.Long id) {
      this.id = id;
      return this;
    }

    @Override
    public RemoveKindCard set(String parameterName, Object value) {
      return (RemoveKindCard) super.set(parameterName, value);
    }
  }
